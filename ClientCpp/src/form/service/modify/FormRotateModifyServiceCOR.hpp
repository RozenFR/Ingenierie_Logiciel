...
#ifndef CLIENTCPP_FORMROTATEMODIFYSERVICECOR_HPP
#define CLIENTCPP_FORMROTATEMODIFYSERVICECOR_HPP
 ...
 */
class FormRotateModifyServiceCOR : public FormModifyServiceCOR {
public:
    /**
    ...
    */
    virtual operator string() const {
        ostringstream oss;
        oss << "[FormRotateModifyServiceCOR]";
        return oss.str();
    }
};


#endif //CLIENTCPP_FORMROTATEMODIFYSERVICECOR_HPP
